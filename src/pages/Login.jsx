        ...
        >
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-white/20 backdrop-blur-sm bg-white/95">
            ...
            <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      className="w-full px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#fe6522]/50 focus:border-transparent transition-all duration-200 bg-white/90 text-sm sm:text-base"  // Added text size
              ...
              <motion.button
                type="submit"
                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-[#fe6522] to-[#e55a1d] text-white font-medium shadow-sm hover:shadow-md transition-all duration-300 text-sm sm:text-base"  // Consistent button height
                whileHover={{ 
                  scale: 1.02,
              ...
              {/* Divider */}
              <div className="relative py-4">  {/* Increased padding */}
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-700 font-medium shadow-sm hover:shadow-md transition-all duration-300 text-sm sm:text-base"  // Consistent button height
                whileHover={{ 
                  scale: 1.02,
