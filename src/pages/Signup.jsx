    ...
    <div className="mt-20 md:mt-30 flex items-center justify-center bg-[#ff6523] p-4 md:overflow-x-hidden">
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute inset-0 flex flex-col md:flex-row gap-2 md:gap-8 justify-center items-center opacity-70">
          <img src={Saffron3} className="sm:block -rotate-20 h-32 w-32 md:h-48 md:w-48 lg:h-64 lg:w-64" alt="Saffron decoration" />
          <img src={Saffron3} className="sm:block rotate-20 h-32 w-32 md:h-48 md:w-48 lg:h-64 lg:w-64" alt="Saffron decoration" />
        </div>
      </div>
        ...
        <div className="bg-white border border-white/20 rounded-2xl shadow-xl overflow-hidden">
          <div className="p-4 sm:p-6 bg-[#ff6523]">
            <div className="flex justify-between items-center">
              ...
              <img src={SaffronIcon} className="h-10 w-10 sm:h-14 sm:w-14" alt="Saffron icon" />
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 bg-white">
              ...
              <div className="flex-1">
                ...
                <motion.div className="relative" whileHover={{ scale: 1.01 }}>
                  <input
                    ...
                    placeholder="First"
                    className="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#fe6522]/50"
                  ...
                  <AnimatePresence>
                    {(focusedFields.firstName || formData.firstName) && (
                      <motion.div className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-[#fe6522] to-[#e55a1d]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} />
                    )}
                  </AnimatePresence>
                </motion.div>
              </div>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02, boxShadow: "0 4px 12px rgba(254, 101, 34, 0.3)" }}
              whileTap={{ scale: 0.98 }}
          ...
          <div className="px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 text-center border-t border-gray-200">
            <p className="text-xs sm:text-sm text-gray-600">
              ...
              <a href="#login" className="font-medium text-[#fe6522] hover:text-[#e55a1d] transition-colors">Log in</a>
            </p>
          </div>
        </div>
      </motion.div>
