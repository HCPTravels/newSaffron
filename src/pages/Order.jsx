    ...
    <div className="min-h-screen pt-20 bg-white rounded-3xl">
      ...
      <div className="max-w-5xl mx-auto py-12 px-4 sm:px-8">
        <div className="text-center mb-12 flex flex-col items-center justify-center">
          ...
          <p className="text-gray-500 text-lg">Your order history and details</p>
        </div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-8">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xl font-bold text-[#ff6523]">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                          ...
                          <div className="text-right space-y-2">
                            ...
                            <div className="flex justify-between text-base font-bold text-[#ff6523]">
                              <span className="mr-4">Total:</span>
                              <span>₹{order.amount?.toFixed ? order.amount.toFixed(2) : order.amount || 'N/A'}</span>
                            </div>
                          </div>
                        </div>
                      </div>
