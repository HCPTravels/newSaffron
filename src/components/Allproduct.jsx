        ...
        features: [
          {
            icon: 'move',
            text: 'Go to details',
            onClick: () => navigate('/ourpartners') // 👈 navigate to another component
          }],
        topMargin: 'mt-[-20px]',
      },
      {
        ...
        features: [
          {
            icon: 'move',
            text: 'Go to details',
            onClick: () => navigate('/aboutus') // 👈 navigate to another component
          }],
        topMargin: 'mt-[-20px]',
        ...
        features: [
          {
            icon: 'move',
            text: 'Go to details',
            onClick: () => navigate('/naturalsaffron') // 👈 navigate to another component
          }],
        topMargin: 'mt-[-20px]',
          ...
          features: [
            {
              icon: 'move',
              text: 'Go to details',
              onClick: () => navigate('/saffronpackaging') // 👈 navigate to another component
            }],
          topMargin: 'mt-[-20px]',
        },
      {
        ...
        features: [
          {
            icon: 'move',
            text: 'Go to details',
            onClick: () => navigate('/precioussaffron') // 👈 navigate to another component
          }],
        topMargin: 'mt-[-20px]',
